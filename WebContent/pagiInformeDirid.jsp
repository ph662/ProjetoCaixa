		...
		<div class="container theme-showcase" role="main" style="padding-left: 0px;">
			...
			<div id="externo">
				<div class="interno" align="center" style="width:50%;">
					...
					<div class="center">
						<h4>Edi&ccedil;&atilde;o 5 - 31/08/2016</h4>
						<img src="imagens/informeDirid/ed5.jpg">
					</div>
					<br>
					<br>
					
					<div class="center">
						<h4>Edi&ccedil;&atilde;o 4 - 17/08/2016</h4>
						<img src="imagens/informeDirid/ed4.jpg">
					</div>
					<br>
					<br>
					
					<div class="center">
						<h4>Edi&ccedil;&atilde;o 3 - 29/07/2016</h4>
						<img src="imagens/informeDirid/edicao-3.jpg">
					</div>
					<br>
					<br>
					
					<div class="center">
						<h4>Edi&ccedil;&atilde;o 2 - 14/07/2016</h4>
						<img src="imagens/informeDirid/ed22.jpg">
					</div>
					<br>
					<br>
					
					<div class="center">
						<h4>Edi&ccedil;&atilde;o 1 - 05/07/2016</h4>
					...
					<br>
					<div class="center">
						<h4>Edi&ccedil;&atilde;o Especial - 04/07/2016</h4>
				...
				<div class="interno" align="center" style="width:50%;">
					...
					<div class="center">
						<h4>Multiplicando Conhecimento</h4>
						<img src="imagens/informeDirid/extraMultiConhec.jpg">
					</div>
					<br>
					<br>
					
					<div class="center">
						<h4>Global Sa&uacute;de 2</h4>
						<img src="imagens/informeDirid/extraGlobalSaude2.jpg">
					</div>
					<br>
					<br>

					<div class="center">
						<h4>Global Sa&uacute;de</h4>
						<img src="imagens/informeDirid/extraGlobalSaude.jpg">
					</div>
					<br>
					<br>
					<div class="center">
