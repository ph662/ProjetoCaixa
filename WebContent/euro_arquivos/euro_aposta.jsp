...
<%@ page import="caixa.dirid.VO.EuroUsuarioVO"%>
<%@ page import="caixa.dirid.VO.EuroPartidasVO"%>
<%@ page import="caixa.dirid.VO.EuroApostasRealizadasVO"%>
...
<html>
	...
	<%
		...
		EuroUsuarioVO usuario = (EuroUsuarioVO) request.getAttribute("objetoUsuario");
	
		String login = (String) request.getAttribute("usuario");
		String senha = (String) request.getAttribute("senha");
		
		List<EuroPartidasVO> partidas = (List<EuroPartidasVO>) request.getAttribute("dadosPartidas");
		List<EuroApostasRealizadasVO> apostasRealizadas = (List<EuroApostasRealizadasVO>) request.getAttribute("apostasRealizadas");
		
		List<EuroPartidasVO> partidasF2 = (List<EuroPartidasVO>) request.getAttribute("dadosPartidasF2");
		List<EuroApostasRealizadasVO> apostasRealizadasF2 = (List<EuroApostasRealizadasVO>) request.getAttribute("apostasRealizadasF2");
		
		List<EuroPartidasVO> partidasF3 = (List<EuroPartidasVO>) request.getAttribute("dadosPartidasF3");
		List<EuroApostasRealizadasVO> apostasRealizadasF3 = (List<EuroApostasRealizadasVO>) request.getAttribute("apostasRealizadasF3");
		
		List<EuroPartidasVO> partidasF4 = (List<EuroPartidasVO>) request.getAttribute("dadosPartidasF4");
		List<EuroApostasRealizadasVO> apostasRealizadasF4 = (List<EuroApostasRealizadasVO>) request.getAttribute("apostasRealizadasF4");
	
		List<EuroPartidasVO> partidasF5 = (List<EuroPartidasVO>) request.getAttribute("dadosPartidasF5");
		List<EuroApostasRealizadasVO> apostasRealizadasF5 = (List<EuroApostasRealizadasVO>) request.getAttribute("apostasRealizadasF5");
...
<head>
	...
	<link rel=Stylesheet href=euro_arquivos/stylesheet.css>
			...
			<table border=0 cellpadding=0 cellspacing=0 width=622
				...
				<tr height=20 style='height: 15.0pt'>
					...
					<span style='mso-ignore: vglayout; position: absolute; z-index: 1; margin-left: 229px; margin-top: 2px; width: 221px; height: 80px'>
						<img width=221 height=76 src="euro_arquivos/image002.png">
					</span>
						<span style='mso-ignore: vglayout2'>
							<table cellpadding=0 cellspacing=0>
								<tr>
									<td colspan=3 rowspan=3 height=60 class=xl92 width=265 style='height: 45.0pt; width: 199pt'>Tabela da Euro 2016</td>
								</tr>
							</table>
						</span>
					</td>
				...
				%>
					<tr height=20 style='height: 15.0pt'>
						...
						<%}else {
								...
								%>
										<td class=xl91><b>Partida 2</b></td>
								<%}else{ %>
										<td class=xl89>&nbsp;</td>
							<%	} %>
						<%} %>
				...
				%>
					<tr height=20 style='height: 15.0pt'>
						...
						<%}else {
								...
								<%}else if(j==2){//linha final
								%>
										<td class=xl80><b>Partida 4</b></td>
								<%}else{ %>
										<td class=xl79>&nbsp;</td>
							<%	} %>
						<%} %>
				...
				%>
					<tr height=20 style='height: 15.0pt'>
						...
						<%}else {
								...
								<%}else if(j==2){//linha final
								%>
										<td class=xl91><b>Partida 6</b></td>
								<%}else{ %>
										<td class=xl89>&nbsp;</td>
							<%	} %>
						<%} %>
				...
				%>
					<tr height=20 style='height: 15.0pt'>
						...
						<%}else {
								...
								<%}else if(j==2){//linha final
								%>
										<td class=xl80><b>Partida 8</b></td>
								<%}else{ %>
										<td class=xl79>&nbsp;</td>
							<%	} %>
						<%} %>
...
<!-- QUARTA FASE SEMI FINAL -->
				...
				%>
					<tr height=20 style='height: 15.0pt'>
						...
						<td></td>
						<%if(j==1){ %>
							<td class=xl90><b>Partida 1</b></td>
						<%}else {
									if(j==1){//linha topo						
									%>
										<td class=xl88>&nbsp;</td>
