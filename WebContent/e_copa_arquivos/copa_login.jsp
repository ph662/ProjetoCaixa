		...
		<tr height=20 style='height: 15.0pt'>
			...
			<td colspan=3 rowspan=3 height=60 width=265	style='height: 45.0pt; width: 199pt' align=left valign=top>
				<span style='mso-ignore: vglayout; position: absolute; z-index: 1; margin-left: 229px; margin-top: 2px; width: 221px; height: 79px'>
					<img width=221 height=75 src=copa.jpg>
				</span>
				<span style='mso-ignore: vglayout2'>
					<table cellpadding=0 cellspacing=0>
						<tr>
							<td colspan=3 rowspan=3 height=60 class=xl81 width=265 style='height: 45.0pt; width: 199pt'>Tabela da Copa 2018</td>
						</tr>
					</table>
				</span>
			</td>
...
<form action="../copaServlet" name="formLogin" onsubmit="return validateForm()" method="POST">
