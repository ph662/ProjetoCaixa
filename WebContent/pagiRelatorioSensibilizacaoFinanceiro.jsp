		...
		<script>
			$(document).ready(function(){
				...
				$('#tipo').on('change', function(){
					...
					//alert($('#tipoAno').val());
					//alert("teste");
					dadosSensibilizacao(ano,mes,"&categ=fluxoFinanceiro");
				...
				$('.category').on('change', function(){
					...
					if(category_list.length == 0)
						...
						var url = "http://"+ip_porta+"/ProjetoCaixa/visaoOperacional?tipo=sensibilizacao&categ=fluxoFinanceiro&pagina=1&mesSensibilizacao="+mes+"&anoSensibilizacao="+ano;
		...
		<div class="container" style="padding-left: 0px; padding-right: 0px;">
			...
			<div class="content">
				<div class="page-header" style="margin-top: 0px; padding-bottom: 10px; margin-bottom: 0px; border-bottom-width: 0px;">
					...
					<h4 style="color:red">Fluxo Financeiro</h4>
